...
final class FreezingArchRuleTests: XCTestCase {
    ...
    // Directory for storing violations
    var violationsDirectory: String!

    // Setup - create test files with layers
    override func setUp() {
        super.setUp()

        // Create a temporary directory for test files
        testFilesDirectory = NSTemporaryDirectory() + "FreezingArchRuleTests_" + UUID().uuidString

        // Create a temporary directory for violation stores
        violationsDirectory = NSTemporaryDirectory() + "FreezingArchRuleViolationsTests_" + UUID().uuidString
    ...
    // MARK: - Freezing Rule Tests

    func testFreezingRuleWithFileStore() {
    ...
    func testFreezingRuleWithInMemoryStore() {
    ...
    func testNewViolationsAfterFreezing() {
        // Create a file path for storing violations
        let violationFilePath = violationsDirectory + "/domain_violations.json"
