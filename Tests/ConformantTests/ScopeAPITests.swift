...
final class ScopeAPITests: XCTestCase {
    ...
    override func setUp() {
        ...
        testFilesDirectory = NSTemporaryDirectory() + "ScopeAPITests_" + UUID().uuidString
    ...
    private func createExtensionFile() throws {
    ...
    private func createEnumFile() throws {
        let enumContent = """
        import Foundation
    ...
    private func createMixedFile() throws {
        let mixedContent = """
        import Foundation
    ...
    func testTopLevelFunctionsRetrieval() {
        let scope = Conformant.scopeFromDirectory(testFilesDirectory)
    ...
    func testTopLevelPropertiesRetrieval() {
        let scope = Conformant.scopeFromDirectory(testFilesDirectory)
